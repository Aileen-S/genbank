...
mkdir 1_raw
cd 1_raw
python3 ~/scratch/github/genbank/search_gb_file.py -g /home/ascott/voglerlab/genbank/$taxon.gb -a ../$taxon.accessionlist.txt -m -i both
mv metadata.csv ..
cd ..
...
----------------------------
Add Mitogenomes and Outgroup
----------------------------
p
mkdir 2_merge
for file in 1_raw/*
do
  cat ../6000/$taxon/${file#*/} $file outgroup/${file#*/} > 2_merge/${file#*/}
done

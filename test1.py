...
# python3 test1.py -e mixedupvoyage@gmail.com -f test.txt -m
...
with open("metadata.csv", "w") as file:     # Open output file
    ...
    writer.writerow(
        ["Accession", "Taxon ID", "BOLD", "Species", '12S', "16S", "18S", "H3", 'Wg',
         'ATP6', 'COX1', 'COX2', 'COX3', 'CYTB', 'ND1', 'ND2', 'ND3', 'ND4', 'ND4L', 'ND5', 'ND6',
         "Suborder", "Infraorder", "Superfamily", "Family", "Subfamily", "Tribe", 'Genus', "Description",  'Label', "Date Late Modified",
...
for rec in record:
    ...
    row = [gbid, txid, bold, species]          # Start row of metadata for CSV
